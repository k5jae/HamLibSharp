...
namespace HamLibSharp
{
	...
	internal class RigCapsNative32 : IRigCapsNative
	{
		// Rig model
		...
		public IntPtr Set_split_freq_mode { get { return set_split_freq_mode; } }
		public IntPtr Get_split_freq_mode { get { return get_split_freq_mode; } }
	...
	[StructLayout (LayoutKind.Sequential, CharSet = CharSet.Ansi)]
	internal class ConfigurationParameter32 : IConfigurationParameter
	{
	...
	[StructLayout (LayoutKind.Sequential)]
	internal struct ChannelList32 : IChannelList
	{
		...
		ChannelCapability32 mem_caps;
	};

	[StructLayout (LayoutKind.Sequential)]
	internal struct ChannelCapability32: IChannelCapability
	{
		private short raw0;
